...
namespace VRTK
{
    ...
    public class VRTK_UIPointer : MonoBehaviour
    {
        ...
        {
            return VRTK_SharedMethods.GetDictionaryValue(pointerLengths, pointerId, false, float.MaxValue);
        }
...
#pragma warning restore 0618
        ...
        protected virtual void LateUpdate()
        {
            if (controllerEvents != null)
            {
                ...
                VRTK_SharedMethods.AddDictionaryValue(ref pointerLengths, pointerEventData.pointerId, maximumLength, true);
            }

    ...
    public class VRTK_ControllerHighlighter : MonoBehaviour
    {
        ...
        public virtual void PopulateHighlighters()
        {
            if (actualController != null)
            {
                ...
                VRTK_SharedMethods.AddDictionaryValue(ref highlighterOptions, "resetMainTexture", true, true);
        ...
        protected virtual Transform GetElementTransform(string path)
        {
            ...
            return VRTK_SharedMethods.GetDictionaryValue(cachedElements, path, true, actualModelContainer.transform.Find(path));
        }

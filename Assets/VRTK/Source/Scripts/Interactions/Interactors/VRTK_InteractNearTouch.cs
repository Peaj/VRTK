...
namespace VRTK
{
    ...
    public class VRTK_InteractNearTouch : MonoBehaviour
    {
        ...
        {
            VRTK_SharedMethods.AddListValue(ref nearTouchedObjects, e.target);
        ...
        {
            VRTK_SharedMethods.RemoveListValue(ref nearTouchedObjects, e.target);
    ...
    public class VRTK_InteractNearTouchCollider : MonoBehaviour
    {
        ...
        protected virtual void OnTriggerEnter(Collider collider)
        {
            ...
            VRTK_SharedMethods.AddListValue(ref nearTouchedObjects, collider.gameObject);
        }

        protected virtual void OnTriggerExit(Collider collider)
        {
            EndNearTouch(collider);
            VRTK_SharedMethods.RemoveListValue(ref nearTouchedObjects, collider.gameObject);
        }

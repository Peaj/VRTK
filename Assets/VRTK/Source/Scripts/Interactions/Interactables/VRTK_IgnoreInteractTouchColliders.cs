...
namespace VRTK
{
    ...
    public class VRTK_IgnoreInteractTouchColliders : VRTK_SDKControllerReady
    {
        ...
        protected virtual void ManageTouchCollision(VRTK_InteractTouch touchToIgnore, bool ignore)
        {
            ...
            VRTK_ControllerTrackedCollider trackedColliderValue = VRTK_SharedMethods.GetDictionaryValue(VRTK_ObjectCache.registeredTrackedColliderToInteractTouches, touchToIgnore, false, null);

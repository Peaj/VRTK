        ...
        */
        ...
        protected virtual bool IsAxisOnHandButtonPress(Dictionary<ButtonTypes, bool> axisHandState, ButtonTypes buttonType, ButtonPressTypes pressType, Vector2 axisValue)
        {
            ...
            if (pressType == ButtonPressTypes.PressDown && !previousAxisState)
            {
                ...
                VRTK_SharedMethods.AddDictionaryValue(ref axisHandState, buttonType, currentAxisState);
        ...
        {
            VRTK_SharedMethods.AddDictionaryValue(ref touchKeyCodes, ButtonTypes.Trigger, StringToKeyCode(joystickIndex, touchCodes[0]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref touchKeyCodes, ButtonTypes.Touchpad, StringToKeyCode(joystickIndex, touchCodes[1]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref touchKeyCodes, ButtonTypes.ButtonOne, StringToKeyCode(joystickIndex, touchCodes[2]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref touchKeyCodes, ButtonTypes.ButtonTwo, StringToKeyCode(joystickIndex, touchCodes[3]), true);

            VRTK_SharedMethods.AddDictionaryValue(ref pressKeyCodes, ButtonTypes.Touchpad, StringToKeyCode(joystickIndex, pressCodes[0]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref pressKeyCodes, ButtonTypes.ButtonOne, StringToKeyCode(joystickIndex, pressCodes[1]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref pressKeyCodes, ButtonTypes.ButtonTwo, StringToKeyCode(joystickIndex, pressCodes[2]), true);
            VRTK_SharedMethods.AddDictionaryValue(ref pressKeyCodes, ButtonTypes.StartMenu, StringToKeyCode(joystickIndex, pressCodes[3]), true);
        }

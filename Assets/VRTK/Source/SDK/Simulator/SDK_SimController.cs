...
namespace VRTK
{
    ...
    public class SDK_SimController : SDK_BaseController
    {
        ...
        {
            return Input.GetKey(VRTK_SharedMethods.GetDictionaryValue(keyMappings, "TouchModifier", false, KeyCode.None));
        }
        ...
        {
            return Input.GetKey(VRTK_SharedMethods.GetDictionaryValue(keyMappings, "HairTouchModifier", false, KeyCode.None));
        }
        ...
        {
            KeyCode buttonCode = VRTK_SharedMethods.GetDictionaryValue(keyMappings, keyMapping, false, KeyCode.None);
